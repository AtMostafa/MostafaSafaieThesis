...
As it pertains to the link between the brain and behavior, it may be much more difficult to infer the algorithms used by the brain from studying the nervous system, compared to understanding it at the computational level.
\par
