...
\paragraph{Topographic Organization of Corticostriatal Projections}
...
However, reduced number of neurons from cortex to \gls{bg} outputs by a factor of more than one million, implies integration of information from distinct circuits to shape the behavior~\cite{Boraud2018ProgNeurobiol}.
\par
...
Moreover, neurons selective for an individual body parts (e.g., forelimb, neck, snout,\ldots) were generally located close in space, making a somatotopic map~\cite{Carelli1991}.
