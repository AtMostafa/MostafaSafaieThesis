...
Reduced vigor in \gls{pd} has been investigated by \citeauthor{Mazzoni2007} to distinguish between speed-accuracy trade-off and energetic cost as two possible determinants of movement speed.
They show that \gls{pd} patients can perform in the arm-reaching task with similar speeds and with comparable accuracy to the control group, however, they have a higher sensitivity to energetic cost and implicitly decide to move at a lower speed~\cite{Mazzoni2007}.
These results suggest that \gls{snc} innervation of the striatum carries a `motor motivation' signal and lack thereof leads to a propensity for slow movements.
