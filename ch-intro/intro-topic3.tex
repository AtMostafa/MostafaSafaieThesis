...
However, the system has a bottleneck:
reduced number of neurons from cortex to \gls{bg} outputs by a factor of more than one million, implies integration of distict information to shape the behavior~\cite{Boraud2018ProgNeurobiol}.
