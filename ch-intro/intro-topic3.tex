...
For instance, infusion of the $GABA_A$ agonist, muscimol, transiently inactivates the surrounding neurons, allowing the researcher to study the functional relevance of the targeted structure.\footnotemark
...
Two experimental conditions differ in the degree to which successive target positions are predictable:
    random positioning of the target in each trial;
    or a predictable sequence of four target positions.
