...
They show that \gls{pd} patients can perform with similar speeds and with comparable accuracy to the control group, however, they have a higher sensitivity to energetic cost and implicitly decide to move at a lower speed~\cite{Mazzoni2007}.
