...
In another study, \Citeauthor*{Bakhurin2017JNeuro} used an operant conditioning paradigm in which the conditioned stimulus was followed by a delayed reward delivery (2.5~s after cue onset) and they monitored anticipatory licking of mice as behavioral readout of temporal perception~\cite{Bakhurin2017JNeuro}.
...
\par
Although symptoms differ from patient to patient, three behavioral symptoms are typical for \gls{pd}:
