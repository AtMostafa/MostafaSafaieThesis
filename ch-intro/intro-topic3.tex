...
For instance, deciding whether the approaching animal is a predator or a prey, or choosing the \textit{best} restaurant~\cite{Bogacz2010TINS}.
...
Crucially, after the subject reached to the target, the rest of the tokens jump more quickly, thus presenting the monkey with a trade-off to either make confident decisions or guess earlier and receive potential rewards sooner.
...
This urgency signal grows over time and and is adjusted to different speed-accuracy trade-off policies, but does not reflect the amount of evidence or the direction chosen by the animal~\cite{Thura2017Neruon}.
...
This suggests a common underlying mechanism.......
