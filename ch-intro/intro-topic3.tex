...
\par
Contrary to the classic model of the \gls{bg}, in which direct pathway activity is pro-kinetic and indirect pathway activity inhibits movement~\cite{Kravitz2010Nature}, and to the action selection model of the \gls{bg} which proposes that direct pathway promotes selected action while indirect pathway concurrently suppresses the competing actions~\cite{Cui2013Nature}, a novel behavioral paradigm revealed that control of movement velocity might be the underlying mechanism implemented by the \gls{bg}.
