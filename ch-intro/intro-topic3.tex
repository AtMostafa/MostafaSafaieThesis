...
Moreover, neurons selective for an individual body part (e.g., forelimb, neck, snout,\dots) were generally located in close proximity, making a somatotopic map~\cite{Carelli1991}.
...
These studies, using multiple injections of anterograde tracers in mice, constructed a comprehensive excitatory input map to the dorsal striatum.
...
Of note, \gls{dms} and \gls{dls} have been suggested as functionally distinct areas, contributing to goal-directed and habitual behaviors, respectively~\cite{Yin2006NatRevNeurosci}.
Another noteworthy result concerns the extent of these areas.
The identified \gls{dls} received inputs from motor cortex, somatosensory cortex, but also frontal association cortex, amygdala, and prelimbic cortex, and expands medially much larger than what is intuitively considered \gls{dls}.
