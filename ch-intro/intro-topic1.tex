...
By introducing time-varying synaptic properties (such as time constant of neurotransmitter release), an optimal Bayesian decoder could produce interval-selective responses, in the range of several hundred milliseconds.
This network also follows the scalar property, given parameters within the physiological range.
