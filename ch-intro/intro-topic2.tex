...
Around 97\% of adults default to counting as a time estimation strategy, and interestingly, in research different sorts of measures has been employed to prevent use of counting instead of a more \textit{pure} time estimation~\cite{Rattat2012}.
