...
\Citeauthor{Berret2018SciReports} show that in a single-joint self-paced arm reaching task, up to 89\% of inter-individual variability of vigor was explained by parameters of \gls{cot} function, e.g., the value of reward~\cite{Berret2018SciReports}.
Interestingly, behavioral trait of `boredom proneness' positively correlated with the slope of the \gls{cot} function derived from the emprical data.
