...
This process has been suggested to constitute a kind of `currency' and it is evolutionary advantageous to live in a way that maximizes this currency~\cite{Shadmehr2019TINS}.
It is called \emph{capture rate} or \emph{reward rate} and in principle, is defined as the sum of the acquired rewards, minus the expended efforts, divided by total elapsed time\cite{Shadmehr2019TINS}.
