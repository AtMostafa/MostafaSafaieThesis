...
This currency is called \emph{capture rate} or \emph{reward rate} and in principle, is defined as the sum of the acquired rewards, minus the expended efforts, divided by total elapsed time~\cite{Shadmehr2019TINS}.
...
That is, substituting estimation of a time interval with a motor program that has two features:
    ...
    2)~Its execution is energetically efficient.
