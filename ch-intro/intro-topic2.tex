...
For example, once submitted to a fixed interval schedule (i.e., reward deliveries every 15~s, irrespective of the animal's behavior), one pigeon started to turn counter-clockwise in the cage two or three times between successive reward deliveries.
