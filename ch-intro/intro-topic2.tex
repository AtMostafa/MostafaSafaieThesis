...
Animals move sooner and faster when there exists the prospect of greater amount of reward.
For instance, in an environment with a higher reward rate, monkeys in a decision-making task, chose the target with shorter deliberation and faster saccade velocity~\cite{Thura2014JNeurosci}.
This phenomenon bridges the between the fields of decision-making and motor control.
