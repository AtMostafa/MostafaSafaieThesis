...
This currency is \emph{capture rate} and in principle, it is defined as the sum of the acquired rewards, minus costs of action, divided by total elapsed time~\cite{Shadmehr2019TINS}.
In the case of time perception, since animals seem to default to a motor strategy to estimate elapsed time, optimizing the capture rate is still a natural and intuitive policy.
