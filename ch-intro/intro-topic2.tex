...
EXAMPLE OF FORAGING.................
This process has been suggested to constitute a kind of `currency' with evolutionary advantages to behave in a way that maximizes it~\cite{Shadmehr2019TINS,Carland2019NeuroSci}.
...
That is, substituting estimation of a time interval with a motor program that has two features:
    1)~Its execution lasts the same duration as the time that needs to be estimated, hence, maximizing the reward and minimizing the denominator of the capture rate;
    2)~Its execution is the least costly.
\par
Reward itself could be considered as a function of economic utility\footnotemark, and the certainty with which the action yields the reward.
\footnotetext{
