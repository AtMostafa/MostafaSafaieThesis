...
\begin{itemize}[noitemsep]
    ...
    \item the treadmill speed was set at 8~cm/s (instead of 10~cm/s) to ensure that starting the trial in the back and remaining still (an anti routine trial) would be rewarded, i.e., $ET\geq 7$.
