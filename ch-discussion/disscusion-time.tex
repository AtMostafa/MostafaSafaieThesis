...
I would confidently say, based on my limited experience with rodents, that no mouse remains freezed for 6~s.
Temporal correlations, in turn, could be covariates of any other motor activity.
Similarly, \Citeauthor{JazayeriNN2018} found temporally scaling dynamics during a time estimation task in the prefrontal cortex \textit{and} \gls{dls} of monkeys, simultaneously~\cite{JazayeriNN2018}.
