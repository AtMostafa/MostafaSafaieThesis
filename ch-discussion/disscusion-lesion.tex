...
This is also supported by a recent pre-print from \citeauthor{Dhawale2019} proposing that the \gls{dls}, and not \gls{dms}, controls the detailed structure of learned behaviors on a moment-to-moment basis, and thus \gls{dls} lesions bring back pre-learning behaviors~\cite{Dhawale2019}.
...
They showed that following \gls{dls} lesions, the lever pressing behavior was similar to na\"{i}ve rats (thus no \textit{vigor} deficit), however animals did not perform their idiosyncratic routine during the interval~\cite{Dhawale2019}.
