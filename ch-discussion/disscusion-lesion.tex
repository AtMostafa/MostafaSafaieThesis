...
Staying in the front could be considered as the extreme (and persistent) version of the `acute' effect after the lesion as well.
While after striatal lesion, majority of animals kept arriving on time in the reward area, but they started to run earlier (i.e., from a more frontal portion of the treadmill) and at a slower velocity (\autoref{fig:lesion:maxPos}).\footnotemark
\footnotetext{
