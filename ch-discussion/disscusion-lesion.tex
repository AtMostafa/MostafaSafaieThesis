...
Assuming a prokinetic role for \gls{da}, our framework (embodied timing, plus the effort function of the \gls{bg}), would suggest that mice might have executed a subtle motor routine during the to-be-estimated interval, the ending of which would have been used as a temporal reference.
...
For instance, \Citeauthor{Gremel2013} showed that after \gls{dms} (\textit{\gls{dls}}) lesions, animals shift toward habitual (\textit{goal-directed}) strategies~\cite{Gremel2013}.
