...
Some animals with larger lesion size, however, failed to learn (\Autoref{fig:lesion:EarlyLesionLearning}{B}), they constantly stayed in the front of the treadmill.
...
\footnotetext{
    ...
    This prediction, however in line with some previous reports, contradicts the results!
