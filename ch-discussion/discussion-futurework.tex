...
An issue is that animals receive smaller quantities of reward if they enter the reward area later (\autoref{fig:methods:taskRules}).
...
This might explain the tendency to wait less.
However, the reward magnitude drops with a low rate, therefore I do not think a $\sim$5\% smaller reward is noticeable.
Anyway, at least for the lesion experiments, a constant reward size after the goal time would have been preferred.
Moreover, 
