...
{\textit{Daniel Kahneman, Thinking, Fast and Slow}}}
\noindent
...
Instead, we explicitly set criteria for including animals in our analyses (\autoref{fig:lesion:maxPos} is an example).
