...
\title{Embodied Time Estimation and the Contribution of the Basal Ganglia}

\submitted{Jan 2020}  % degree conferral date (January, April, June, September, or November)
\copyrightyear{2020}  % year in which the copyright is secured by publication of the dissertation.
\author{Mostafa Safaie}
\adviser{Doctor David Robbe}  %replace with the full name of your adviser
